...
Required operational instructions and reference for agents working in this
repository. The canonical entry point and shared development policies are in
[AGENTS.md](../AGENTS.md). Keep this companion separate so the root instruction
file stays below
[Codex's default 32 KiB project-instruction limit](https://learn.chatgpt.com/docs/agent-configuration/agents-md).
`CLAUDE.md` imports `AGENTS.md`; Gemini and Cursor point directly to it.
The entry point requires reading this companion before acting in the repo.
...
Follow [Project Directory Storage](../AGENTS.md#project-directory-storage)
