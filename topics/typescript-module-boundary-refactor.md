...
- Follow the DEVELOPMENT.md commit message guidance. Every slice commit carries
...
| Codex provider source/protocol | Codex version bump audit rules in `DEVELOPMENT.md` | Codex provider tests; stream/persisted render parity where relevant |
