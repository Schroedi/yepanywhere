...
Recurred 2026-09-24 in the full publish run with the same count-1 failure at
line 93; the spec file again passed 4 of 4 alone. Two of two recent full runs
have hit it, so it now blocks `publish.sh` routinely.
